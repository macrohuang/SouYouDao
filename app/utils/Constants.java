...
public class Constants {
  ...
  public static final String SCENIC_INDEX_PATH = FileUtil.getApplicationPath("data","scenic","indexes");
  //打开景点索引目录
  ...
  public static final IndexWriter CREATE_INDEX_WRITER(Directory directory) throws Exception {
    ...
    IndexWriter writer = new IndexWriter(directory,Constants.analyzer,true,IndexWriter.MaxFieldLength.LIMITED);
    return writer;
  }
  //创建索引检索工具
